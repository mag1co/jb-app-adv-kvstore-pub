 ...
 *   - kvhelper.js in the same workflow package with TOKEN set in config.js
...
exports.rule = entities.Issue.action({
  ...
  action: function (ctx) {
    workflow.check(config.YOUTRACK_BASE_URL && config.YOUTRACK_TOKEN,
      'KVStore: Set YOUTRACK_BASE_URL and YOUTRACK_TOKEN in config.js');
